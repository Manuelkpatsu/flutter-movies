...
import 'package:fluttermovieapp/utils/star_calculator.dart'
as starCalculator;
...
class DetailScreen extends StatefulWidget {
  ...
  DetailScreen({required this.id, required this.themeColor});
  @override
...
class _DetailScreenState extends State<DetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: (stars == null)
          ? CustomLoader(loadingColor: widget.themeColor)
          : CustomScrollView(
        slivers: [
          SliverAppBar(
