...
import 'package:fluttermovieapp/widgets/colored_circle.dart';
import 'package:fluttermovieapp/widgets/drawer_item.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              DrawerItem(title: kDrawerTitleThirdText, desc: kDrawerDependenciesDescText),
            ],
          ),
        ),
      ),
